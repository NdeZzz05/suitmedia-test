...
const Card = React.forwardRef(({ className, ...props }, ref) => <div ref={ref} className={cn("rounded-lg border bg-card text-card-foreground shadow-md", className)} {...props} />);
Card.displayName = "Card";

const CardNavbar = React.forwardRef(({ className, ...props }, ref) => <div ref={ref} className={cn("bg-card text-card-foreground shadow-sm", className)} {...props} />);
Card.displayName = "CardNavbar";
...
export { Card, CardNavbar, CardHeader, CardFooter, CardTitle, CardDescription, CardContent };
